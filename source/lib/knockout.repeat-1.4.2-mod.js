...
ko.bindingHandlers['repeat'] = {
    ...
    'init': function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
        ...
        element.removeAttribute('data-uncrd');

        // extract and remove a data-repeat-uncrd attribute, if present
        if (!repeatBind) {
            repeatBind = element.getAttribute('data-repeat-uncrd');
            if (repeatBind) {
                element.removeAttribute('data-repeat-uncrd');
            }
        }
        ...
        if (typeof repeatBind == "string") {
            cleanNode.setAttribute('data-uncrd', repeatBind);
            repeatBind = null;
        }
